...
import '../../../greensock/plugins/DrawSVGPlugin';

export default class ExperimentalLoader extends Component {
  init = () => {
  ...
  render () {
    return(
      <div className="e-loader-wrapper">
       ...
       <path ref="prog1" style={{fill:'#FC6E51'}} d="M373.243,74.644H53.317c-5.89,0-10.669,4.78-10.669,10.669c0,5.89,4.78,10.67,10.669,10.67h319.926
         c5.889,0,10.67-4.78,10.67-10.67C383.913,79.424,379.131,74.644,373.243,74.644z"/>
       <path ref="prog2" style={{fill:'#AC92EB'}} d="M53.317,138.63h170.632c5.89,0,10.654-4.765,10.654-10.654c0-5.905-4.764-10.669-10.654-10.669
         H53.317c-5.89,0-10.669,4.764-10.669,10.669C42.647,133.865,47.427,138.63,53.317,138.63z"/>
       <path ref="prog3" style={{fill:'#48CFAD'}} d="M53.317,181.29h234.618c5.89,0,10.654-4.78,10.654-10.669s-4.765-10.653-10.654-10.653H53.317
         c-5.89,0-10.669,4.764-10.669,10.653C42.647,176.51,47.427,181.29,53.317,181.29z"/>
       <path ref="prog4" style={{fill:'#5D9CEC'}} d="M53.317,223.938l149.293,0.016c5.905,0,10.669-4.78,10.669-10.669
       ...
       <path ref="prog5" style={{fill:'#FFCE54'}} d="M330.581,245.275H53.317c-5.89,0-10.669,4.78-10.669,10.654c0,5.905,4.78,10.67,10.669,10.67h277.264
         c5.905,0,10.67-4.765,10.67-10.654C341.251,250.057,336.486,245.275,330.581,245.275z"/>
       <path ref="prog6" style={{fill:'#ED5564'}} d="M138.625,287.93H53.317c-5.89,0-10.669,4.781-10.669,10.654c0,5.905,4.78,10.686,10.669,10.686
