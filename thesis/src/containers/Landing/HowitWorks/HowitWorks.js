    ...
    return (
      <div className="landing-wrapper">
        <div className='how-works-banner'>
          <h1 className='how-label'>How does it work?</h1>
        </div>
        <div className='how-container'>
          <div className='landing-desc-how'>
            <div className='section1-personal'>
              <div>
              ...
              <div className='icon-howitworks'></div>
            </div>
            <div className='section2-works'>
              <div className='section2-words'>
                ...
                <Link to='/'>
                  <input type="submit" className='SectionDividerButton-works' value="Back" />
                </Link>
              </div>
            </div>
          </div>
